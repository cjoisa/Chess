...
int board[8][8], bCopy[8][8], mov[32];              //board : main chess board, bCopy : Copy of board(for undo), mov : number of moves per piece
int UNDO = 1;                                       //To check if UNDO is used twice in a row
